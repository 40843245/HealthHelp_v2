package com.tibame.tip101.group_02.healthhelp_v2.util.dbms.queryhandling.clausemaker.conditionsmaker
...
open class ConditionsBuilder {
    ...
    fun condition(condition:List<String>): ConditionsBuilder {
        this.conditions.addAll(condition)
        return this
    }
    ...
    fun logicalOperator(logicalOperator:List<String>): ConditionsBuilder {
        this.logicalOperators.addAll(logicalOperator)
        return this
    }
    ...
    fun build():String {
        ...
        for(i in 1..<this.conditions.size){
