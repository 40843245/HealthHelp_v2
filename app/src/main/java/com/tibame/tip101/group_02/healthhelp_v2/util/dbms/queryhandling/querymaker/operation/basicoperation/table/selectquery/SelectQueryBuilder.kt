package com.tibame.tip101.group_02.healthhelp_v2.util.dbms.queryhandling.querymaker.operation.basicoperation.table.selectquery
...
class SelectQueryBuilder(): BaseQuery() {
    ...
    override fun column(column: List<String>): SelectQueryBuilder {
        super.column(column)
        return this
    }
